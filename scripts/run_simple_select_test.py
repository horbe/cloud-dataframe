...
import threading
import queue
rootPath = '/Users/ahauser/Documents/work'
sys.path.append(rootPath + '/dataframe/cloud-dataframe')
...
def start_repl():
    ...
    repl_dir = rootPath + "/legend/legend-engine/legend-engine-config/legend-engine-repl/legend-engine-repl-relational"
